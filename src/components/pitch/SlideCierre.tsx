...
export default function SlideCierre() {
  return (
    <div className="w-full h-full flex flex-col bg-white relative overflow-hidden">
      ...
      >
        <div className="bg-[#0D0D0D] py-8 px-12">
          {/* Hablemos */}
          <p className="text-[#C4B8A8] text-sm font-bold uppercase tracking-[0.2em] text-center mb-6">
            Hablemos
          </p>
          ...
          <div className="flex items-center justify-center gap-16 mb-8">
            {founders.map((founder, index) => (
              ...
              >
                ...
                <p className="text-white text-base font-bold">{founder.name}</p>
                <p className="text-[#C4B8A8] text-sm">{founder.role}</p>
              </motion.div>
            ))}
          </div>
          ...
          <div className="border-t border-white/10 pt-6 text-center">
            <p className="font-serif text-3xl text-white font-bold tracking-tight">
              LUMEN
            </p>
            <p className="text-[#C4B8A8] text-sm mt-2">
